...
type
  ...
  ImGuiStoragePair* {.importc: "ImGuiStoragePair",
      header: imgui_header.} = object
  ...
  ImPairData* {.union.} = object
    ...
    val_f* {.importc: "val_f".}: float32
    val_p* {.importc: "val_p".}: pointer
  ImPair* {.importc: "Pair", header: imgui_header.} = object
    key* {.importc: "key".}: ImGuiID
    data*: ImPairData
  ImDrawListSharedData* {.importc: "ImDrawListSharedData",
      header: imgui_header.} = object
  ImGuiContext* {.importc: "ImGuiContext", header: imgui_header.} = object
  ImColor* {.importc: "ImColor", header: imgui_header.} = object
    value* {.importc: "Value".}: ImVec4
  ImDrawChannel* {.importc: "ImDrawChannel", header: imgui_header.} = object
    cmdBuffer* {.importc: "_CmdBuffer".}: ImVector[ImDrawCmd]
    idxBuffer* {.importc: "_IdxBuffer".}: ImVector[ImDrawIdx]
  ImDrawCmd* {.importc: "ImDrawCmd", header: imgui_header.} = object
  ...
  ImDrawData* {.importc: "ImDrawData", header: imgui_header.} = object
  ...
  ImDrawList* {.importc: "ImDrawList", header: imgui_header.} = object
  ...
  ImFontAtlas* {.importc: "ImFontAtlas", header: imgui_header.} = object
  ...
  ImFontConfig* {.importc: "ImFontConfig", header: imgui_header.} = object
  ...
  ImFontGlyph* {.importc: "ImFontGlyph", header: imgui_header.} = object
  ...
  ImGuiIO* {.importc: "ImGuiIO", header: imgui_header.} = object
    ...
    configWindowsMoveFromTitleBarOnly* {.
        importc: "ConfigWindowsMoveFromTitleBarOnly".}: bool
  ...
  ImGuiListClipper* {.importc: "ImGuiListClipper",
      header: imgui_header.} = object
  ...
  ImGuiOnceUponAFrame* {.importc: "ImGuiOnceUponAFrame",
      header: imgui_header.} = object
    refFrame* {.importc: "RefFrame".}: int32
  ImGuiPayload* {.importc: "ImGuiPayload", header: imgui_header.} = object
  ...
  ImGuiStorage* {.importc: "ImGuiStorage", header: imgui_header.} = object
    data* {.importc: "Data".}: ImVector[ImGuiStoragePair]
  ImGuiStyle* {.importc: "ImGuiStyle", header: imgui_header.} = object
  ...
  ImGuiTextBuffer* {.importc: "ImGuiTextBuffer", header: imgui_header.} = object
    buf* {.importc: "Buf".}: ImVector[int8]
  ImGuiTextFilter* {.importc: "ImGuiTextFilter", header: imgui_header.} = object
...
proc hsv*(self: ptr ImColor, h: float32, s: float32, v: float32,
    a: float32 = 1.0f): ImColor {.importc: "ImColor_HSV".}
proc newImColor*(): void {.importc: "ImColor_ImColor".}
proc newImColor*(r: int32, g: int32, b: int32, a: int32 = 255): void {.
    importc: "ImColor_ImColorInt".}
proc newImColor*(rgba: uint32): void {.importc: "ImColor_ImColorU32".}
proc newImColor*(r: float32, g: float32, b: float32, a: float32 = 1.0f): void {.
    importc: "ImColor_ImColorFloat".}
...
proc scaleClipRects*(self: ptr ImDrawData, fb_scale: ImVec2): void {.
    importc: "ImDrawData_ScaleClipRects".}
...
proc clearFreeMemory*(self: ptr ImDrawListSplitter): void {.
    importc: "ImDrawListSplitter_ClearFreeMemory".}
...
proc addBezierCurve*(self: ptr ImDrawList, pos0: ImVec2, cp0: ImVec2,
    cp1: ImVec2, pos1: ImVec2, col: uint32, thickness: float32,
    num_segments: int32 = 0): void {.importc: "ImDrawList_AddBezierCurve".}
...
proc addCircle*(self: ptr ImDrawList, center: ImVec2, radius: float32,
    col: uint32, num_segments: int32 = 12, thickness: float32 = 1.0f): void {.
    importc: "ImDrawList_AddCircle".}
proc addCircleFilled*(self: ptr ImDrawList, center: ImVec2, radius: float32,
    col: uint32, num_segments: int32 = 12): void {.
...
proc addDrawCmd*(self: ptr ImDrawList): void {.
    importc: "ImDrawList_AddDrawCmd".}
proc addImage*(self: ptr ImDrawList, user_texture_id: ImTextureID,
    p_min: ImVec2, p_max: ImVec2, uv_min: ImVec2 = ImVec2(x: 0, y: 0),
...
proc addImageQuad*(self: ptr ImDrawList, user_texture_id: ImTextureID,
    ...
    y: 0), uv2: ImVec2 = ImVec2(x: 1, y: 0), uv3: ImVec2 = ImVec2(x: 1, y: 1),
...
proc addQuad*(self: ptr ImDrawList, p1: ImVec2, p2: ImVec2, p3: ImVec2,
    p4: ImVec2, col: uint32, thickness: float32 = 1.0f): void {.
...
proc addText*(self: ptr ImDrawList, font: ptr ImFont, font_size: float32,
    ...
    wrap_width: float32 = 0.0f, cpu_fine_clip_rect: ptr ImVec4 = nil): void {.
    importc: "ImDrawList_AddTextFontPtr".}
proc addTriangle*(self: ptr ImDrawList, p1: ImVec2, p2: ImVec2, p3: ImVec2,
    col: uint32, thickness: float32 = 1.0f): void {.
    importc: "ImDrawList_AddTriangle".}
...
proc clearFreeMemory*(self: ptr ImDrawList): void {.
    importc: "ImDrawList_ClearFreeMemory".}
proc cloneOutput*(self: ptr ImDrawList): ptr ImDrawList {.
    importc: "ImDrawList_CloneOutput".}
proc getClipRectMax*(self: ptr ImDrawList): ImVec2 {.
    importc: "ImDrawList_GetClipRectMax".}
proc getClipRectMin*(self: ptr ImDrawList): ImVec2 {.
    importc: "ImDrawList_GetClipRectMin".}
proc newImDrawList*(shared_data: ptr ImDrawListSharedData): void {.
    importc: "ImDrawList_ImDrawList".}
...
proc pathBezierCurveTo*(self: ptr ImDrawList, p1: ImVec2, p2: ImVec2,
    p3: ImVec2, num_segments: int32 = 0): void {.
    importc: "ImDrawList_PathBezierCurveTo".}
...
proc pathLineToMergeDuplicate*(self: ptr ImDrawList, pos: ImVec2): void {.
    importc: "ImDrawList_PathLineToMergeDuplicate".}
...
proc primWriteIdx*(self: ptr ImDrawList, idx: ImDrawIdx): void {.
    importc: "ImDrawList_PrimWriteIdx".}
...
proc updateClipRect*(self: ptr ImDrawList): void {.
    importc: "ImDrawList_UpdateClipRect".}
proc updateTextureID*(self: ptr ImDrawList): void {.
    importc: "ImDrawList_UpdateTextureID".}
proc destroy*(self: ptr ImDrawList): void {.importc: "ImDrawList_destroy".}
proc newImFontAtlasCustomRect*(): void {.
    importc: "ImFontAtlasCustomRect_ImFontAtlasCustomRect".}
proc isPacked*(self: ptr ImFontAtlasCustomRect): bool {.
    importc: "ImFontAtlasCustomRect_IsPacked".}
proc destroy*(self: ptr ImFontAtlasCustomRect): void {.
    importc: "ImFontAtlasCustomRect_destroy".}
...
proc addCustomRectRegular*(self: ptr ImFontAtlas, id: uint32, width: int32,
...
proc addFont*(self: ptr ImFontAtlas, font_cfg: ptr ImFontConfig): ptr ImFont {.
    importc: "ImFontAtlas_AddFont".}
proc addFontDefault*(self: ptr ImFontAtlas,
    font_cfg: ptr ImFontConfig = nil): ptr ImFont {.
    importc: "ImFontAtlas_AddFontDefault".}
...
proc addFontFromMemoryCompressedTTF*(self: ptr ImFontAtlas,
    ...
    size_pixels: float32, font_cfg: ptr ImFontConfig = nil,
    glyph_ranges: ptr ImWchar = nil): ptr ImFont {.
    importc: "ImFontAtlas_AddFontFromMemoryCompressedTTF".}
proc addFontFromMemoryTTF*(self: ptr ImFontAtlas, font_data: pointer,
    ...
    glyph_ranges: ptr ImWchar = nil): ptr ImFont {.
    importc: "ImFontAtlas_AddFontFromMemoryTTF".}
...
proc getCustomRectByIndex*(self: ptr ImFontAtlas,
    index: int32): ptr ImFontAtlasCustomRect {.
    importc: "ImFontAtlas_GetCustomRectByIndex".}
proc getGlyphRangesChineseFull*(self: ptr ImFontAtlas): ptr ImWchar {.
    importc: "ImFontAtlas_GetGlyphRangesChineseFull".}
proc getGlyphRangesChineseSimplifiedCommon*(
  self: ptr ImFontAtlas): ptr ImWchar {.
    importc: "ImFontAtlas_GetGlyphRangesChineseSimplifiedCommon".}
proc getGlyphRangesCyrillic*(self: ptr ImFontAtlas): ptr ImWchar {.
    importc: "ImFontAtlas_GetGlyphRangesCyrillic".}
proc getGlyphRangesDefault*(self: ptr ImFontAtlas): ptr ImWchar {.
    importc: "ImFontAtlas_GetGlyphRangesDefault".}
proc getGlyphRangesJapanese*(self: ptr ImFontAtlas): ptr ImWchar {.
    importc: "ImFontAtlas_GetGlyphRangesJapanese".}
proc getGlyphRangesKorean*(self: ptr ImFontAtlas): ptr ImWchar {.
    importc: "ImFontAtlas_GetGlyphRangesKorean".}
...
proc getGlyphRangesVietnamese*(self: ptr ImFontAtlas): ptr ImWchar {.
    importc: "ImFontAtlas_GetGlyphRangesVietnamese".}
proc getMouseCursorTexData*(self: ptr ImFontAtlas, cursor: ImGuiMouseCursor,
    ...
    ImVec2], out_uv_fill: var array[2, ImVec2]): bool {.
...
proc addText*(self: ptr ImFontGlyphRangesBuilder, text: cstring,
    ...
    importc: "ImFontGlyphRangesBuilder_AddText".}
...
proc clear*(self: ptr ImFontGlyphRangesBuilder): void {.
    importc: "ImFontGlyphRangesBuilder_Clear".}
proc getBit*(self: ptr ImFontGlyphRangesBuilder, n: int32): bool {.
    importc: "ImFontGlyphRangesBuilder_GetBit".}
proc newImFontGlyphRangesBuilder*(): void {.
    importc: "ImFontGlyphRangesBuilder_ImFontGlyphRangesBuilder".}
proc setBit*(self: ptr ImFontGlyphRangesBuilder, n: int32): void {.
    importc: "ImFontGlyphRangesBuilder_SetBit".}
proc destroy*(self: ptr ImFontGlyphRangesBuilder): void {.
    importc: "ImFontGlyphRangesBuilder_destroy".}
proc addGlyph*(self: ptr ImFont, c: ImWchar, x0: float32, y0: float32,
    x1: float32, y1: float32, u0: float32, v0: float32, u1: float32,
    v1: float32, advance_x: float32): void {.importc: "ImFont_AddGlyph".}
...
proc calcTextSizeA*(self: ptr ImFont, size: float32, max_width: float32,
    wrap_width: float32, text_begin: cstring, text_end: cstring = nil,
    remaining: ptr cstring = nil): ImVec2 {.importc: "ImFont_CalcTextSizeA".}
...
proc findGlyphNoFallback*(self: ptr ImFont, c: ImWchar): ptr ImFontGlyph {.
    importc: "ImFont_FindGlyphNoFallback".}
...
proc setFallbackChar*(self: ptr ImFont, c: ImWchar): void {.
    importc: "ImFont_SetFallbackChar".}
...
proc addInputCharactersUTF8*(self: ptr ImGuiIO, str: cstring): void {.
    importc: "ImGuiIO_AddInputCharactersUTF8".}
...
proc deleteChars*(self: ptr ImGuiInputTextCallbackData, pos: int32,
    ...
    importc: "ImGuiInputTextCallbackData_DeleteChars".}
...
proc newImGuiInputTextCallbackData*(): void {.
    importc: "ImGuiInputTextCallbackData_ImGuiInputTextCallbackData".}
...
proc destroy*(self: ptr ImGuiInputTextCallbackData): void {.
    importc: "ImGuiInputTextCallbackData_destroy".}
proc begin*(self: ptr ImGuiListClipper, items_count: int32,
    items_height: float32 = -1.0f): void {.importc: "ImGuiListClipper_Begin".}
proc `end`*(self: ptr ImGuiListClipper): void {.
    importc: "ImGuiListClipper_End".}
proc newImGuiListClipper*(items_count: int32 = -1,
    items_height: float32 = -1.0f): void {.
    importc: "ImGuiListClipper_ImGuiListClipper".}
proc step*(self: ptr ImGuiListClipper): bool {.
...
proc isDataType*(self: ptr ImGuiPayload, `type`: cstring): bool {.
    importc: "ImGuiPayload_IsDataType".}
...
proc newImGuiStoragePair*(key: ImGuiID, val_i: int32): void {.
    importc: "ImGuiStoragePair_ImGuiStoragePairInt".}
proc newImGuiStoragePair*(key: ImGuiID, val_f: float32): void {.
    importc: "ImGuiStoragePair_ImGuiStoragePairFloat".}
proc newImGuiStoragePair*(key: ImGuiID, val_p: pointer): void {.
    importc: "ImGuiStoragePair_ImGuiStoragePairPtr".}
...
proc getFloatRef*(self: ptr ImGuiStorage, key: ImGuiID,
    default_val: float32 = 0.0f): ptr float32 {.
...
proc getVoidPtr*(self: ptr ImGuiStorage, key: ImGuiID): pointer {.
    importc: "ImGuiStorage_GetVoidPtr".}
...
proc appendf*(self: ptr ImGuiTextBuffer, fmt: cstring): void {.
    importc: "ImGuiTextBuffer_appendf", varargs.}
proc appendfv*(self: ptr ImGuiTextBuffer, fmt: cstring): void {.
    importc: "ImGuiTextBuffer_appendfv", varargs.}
...
proc build*(self: ptr ImGuiTextFilter): void {.
    importc: "ImGuiTextFilter_Build".}
proc clear*(self: ptr ImGuiTextFilter): void {.
...
proc newImGuiTextRange*(b: cstring, e: cstring): void {.
    importc: "ImGuiTextRange_ImGuiTextRangeStr".}
...
proc contains*[T](self: ptr ImVector, v: T): bool {.
    importc: "ImVector_contains".}
...
proc igAcceptDragDropPayload*(`type`: cstring,
    ...
    importc: "igAcceptDragDropPayload".}
...
proc igBeginChild*(str_id: cstring, size: ImVec2 = ImVec2(x: 0, y: 0),
    border: bool = false, flags: ImGuiWindowFlags = 0.ImGuiWindowFlags): bool {.
    importc: "igBeginChild".}
proc igBeginChild*(id: ImGuiID, size: ImVec2 = ImVec2(x: 0, y: 0),
    border: bool = false, flags: ImGuiWindowFlags = 0.ImGuiWindowFlags): bool {.
    importc: "igBeginChildID".}
...
proc igBeginPopupContextItem*(str_id: cstring = nil,
    mouse_button: int32 = 1): bool {.importc: "igBeginPopupContextItem".}
proc igBeginPopupContextVoid*(str_id: cstring = nil,
    mouse_button: int32 = 1): bool {.importc: "igBeginPopupContextVoid".}
proc igBeginPopupContextWindow*(str_id: cstring = nil, mouse_button: int32 = 1,
    also_over_items: bool = true): bool {.importc: "igBeginPopupContextWindow".}
...
proc igCollapsingHeader*(label: cstring,
    ...
    importc: "igCollapsingHeader".}
proc igCollapsingHeader*(label: cstring, p_open: ptr bool,
    flags: ImGuiTreeNodeFlags = 0.ImGuiTreeNodeFlags): bool {.
    importc: "igCollapsingHeaderBoolPtr".}
proc igColorButton*(desc_id: cstring, col: ImVec4,
    flags: ImGuiColorEditFlags = 0.ImGuiColorEditFlags, size: ImVec2 = ImVec2(
    x: 0, y: 0)): bool {.importc: "igColorButton".}
proc igColorConvertFloat4ToU32*(`in`: ImVec4): uint32 {.
    importc: "igColorConvertFloat4ToU32".}
proc igColorConvertHSVtoRGB*(h: float32, s: float32, v: float32, out_r: float32,
    out_g: float32, out_b: float32): void {.importc: "igColorConvertHSVtoRGB".}
proc igColorConvertRGBtoHSV*(r: float32, g: float32, b: float32, out_h: float32,
    out_s: float32, out_v: float32): void {.importc: "igColorConvertRGBtoHSV".}
proc igColorConvertU32ToFloat4*(`in`: uint32): ImVec4 {.
...
proc igCombo*(label: cstring, current_item: ptr int32,
    ...
    popup_max_height_in_items: int32 = -1): bool {.importc: "igComboStr".}
proc igCombo*(label: cstring, current_item: ptr int32, items_getter: proc(
    data: pointer, idx: int32, out_text: ptr cstring): bool, data: pointer,
    items_count: int32, popup_max_height_in_items: int32 = -1): bool {.
    importc: "igComboFnPtr".}
proc igCreateContext*(shared_font_atlas: ptr ImFontAtlas = nil): ptr ImGuiContext {.
    importc: "igCreateContext".}
...
proc igDragScalar*(label: cstring, data_type: ImGuiDataType, p_data: pointer,
    ...
    format: cstring = nil, power: float32 = 1.0f): bool {.
...
proc igDragScalarN*(label: cstring, data_type: ImGuiDataType, p_data: pointer,
    ...
    p_max: pointer = nil, format: cstring = nil, power: float32 = 1.0f): bool {.
...
proc igGetBackgroundDrawList*(): ptr ImDrawList {.
    importc: "igGetBackgroundDrawList".}
proc igGetClipboardText*(): cstring {.importc: "igGetClipboardText".}
proc igGetColorU32*(idx: ImGuiCol, alpha_mul: float32 = 1.0f): uint32 {.
    importc: "igGetColorU32".}
...
proc igGetDragDropPayload*(): ptr ImGuiPayload {.
...
proc igGetForegroundDrawList*(): ptr ImDrawList {.
    importc: "igGetForegroundDrawList".}
...
proc igGetMouseDragDelta*(button: int32 = 0,
    lock_threshold: float32 = -1.0f): ImVec2 {.importc: "igGetMouseDragDelta".}
proc igGetMousePos*(): ImVec2 {.importc: "igGetMousePos".}
proc igGetMousePosOnOpeningCurrentPopup*(): ImVec2 {.
...
proc igGetWindowContentRegionMin*(): ImVec2 {.
...
proc igImage*(user_texture_id: ImTextureID, size: ImVec2, uv0: ImVec2 = ImVec2(
    x: 0, y: 0), uv1: ImVec2 = ImVec2(x: 1, y: 1), tint_col: ImVec4 = ImVec4(
    x: 1, y: 1, z: 1, w: 1), border_col: ImVec4 = ImVec4(x: 0, y: 0, z: 0,
    w: 0)): void {.importc: "igImage".}
proc igImageButton*(user_texture_id: ImTextureID, size: ImVec2,
    uv0: ImVec2 = ImVec2(x: 0, y: 0), uv1: ImVec2 = ImVec2(x: 1, y: 1),
    frame_padding: int32 = -1, bg_col: ImVec4 = ImVec4(x: 0, y: 0, z: 0, w: 0),
...
proc igInputText*(label: cstring, buf: cstring, buf_size: uint,
    ...
    callback: ImGuiInputTextCallback = nil, user_data: pointer = nil): bool {.
    importc: "igInputText".}
...
proc igInvisibleButton*(str_id: cstring, size: ImVec2): bool {.
...
proc igIsItemClicked*(mouse_button: int32 = 0): bool {.
...
proc igIsKeyPressed*(user_key_index: int32, repeat: bool = true): bool {.
    importc: "igIsKeyPressed".}
proc igIsKeyReleased*(user_key_index: int32): bool {.
    importc: "igIsKeyReleased".}
proc igIsMouseClicked*(button: int32, repeat: bool = false): bool {.
    importc: "igIsMouseClicked".}
proc igIsMouseDoubleClicked*(button: int32): bool {.
    importc: "igIsMouseDoubleClicked".}
proc igIsMouseDown*(button: int32): bool {.importc: "igIsMouseDown".}
proc igIsMouseDragging*(button: int32 = 0,
...
proc igLabelTextV*(label: cstring, fmt: cstring): void {.
    importc: "igLabelTextV", varargs.}
proc igListBox*(label: cstring, current_item: ptr int32, items: ptr cstring,
    items_count: int32, height_in_items: int32 = -1): bool {.
    importc: "igListBoxStr_arr".}
proc igListBox*(label: cstring, current_item: ptr int32, items_getter: proc(
    data: pointer, idx: int32, out_text: ptr cstring): bool, data: pointer,
    items_count: int32, height_in_items: int32 = -1): bool {.
    importc: "igListBoxFnPtr".}
proc igListBoxFooter*(): void {.importc: "igListBoxFooter".}
proc igListBoxHeader*(label: cstring, size: ImVec2 = ImVec2(x: 0,
    y: 0)): bool {.importc: "igListBoxHeaderVec2".}
proc igListBoxHeader*(label: cstring, items_count: int32,
    height_in_items: int32 = -1): bool {.importc: "igListBoxHeaderInt".}
...
proc igOpenPopupOnItemClick*(str_id: cstring = nil,
    mouse_button: int32 = 1): bool {.importc: "igOpenPopupOnItemClick".}
proc igPlotHistogram*(label: cstring, values: ptr float32, values_count: int32,
    ...
    graph_size: ImVec2 = ImVec2(x: 0, y: 0), stride: int32 = sizeof(
    float32).int32): void {.importc: "igPlotHistogramFloatPtr".}
proc igPlotHistogram*(label: cstring, values_getter: proc(data: pointer,
    idx: int32): float32, data: pointer, values_count: int32,
    values_offset: int32 = 0, overlay_text: cstring = nil,
    scale_min: float32 = high(float32), scale_max: float32 = high(float32),
    graph_size: ImVec2 = ImVec2(x: 0, y: 0)): void {.
    importc: "igPlotHistogramFnPtr".}
proc igPlotLines*(label: cstring, values: ptr float32, values_count: int32,
    values_offset: int32 = 0, overlay_text: cstring = nil,
    scale_min: float32 = high(float32), scale_max: float32 = high(float32),
    graph_size: ImVec2 = ImVec2(x: 0, y: 0), stride: int32 = sizeof(
    float32).int32): void {.importc: "igPlotLines".}
proc igPlotLines*(label: cstring, values_getter: proc(data: pointer,
    idx: int32): float32, data: pointer, values_count: int32,
    values_offset: int32 = 0, overlay_text: cstring = nil,
    scale_min: float32 = high(float32), scale_max: float32 = high(float32),
    graph_size: ImVec2 = ImVec2(x: 0, y: 0)): void {.
    importc: "igPlotLinesFnPtr".}
...
proc igProgressBar*(fraction: float32, size_arg: ImVec2 = ImVec2(x: -1, y: 0),
...
proc igSelectable*(label: cstring, selected: bool = false,
    ...
    x: 0, y: 0)): bool {.importc: "igSelectable".}
proc igSelectable*(label: cstring, p_selected: ptr bool,
    flags: ImGuiSelectableFlags = 0.ImGuiSelectableFlags, size: ImVec2 = ImVec2(
    x: 0, y: 0)): bool {.importc: "igSelectableBoolPtr".}
proc igSeparator*(): void {.importc: "igSeparator".}
proc igSetAllocatorFunctions*(alloc_func: proc(sz: uint,
    user_data: pointer): pointer, free_func: proc(`ptr`: pointer,
    user_data: pointer): void, user_data: pointer = nil): void {.
...
proc igSetCursorScreenPos*(pos: ImVec2): void {.
...
proc igSetMouseCursor*(`type`: ImGuiMouseCursor): void {.
...
proc igSetNextWindowPos*(pos: ImVec2, cond: ImGuiCond = 0.ImGuiCond,
    pivot: ImVec2 = ImVec2(x: 0, y: 0)): void {.importc: "igSetNextWindowPos".}
...
proc igSetScrollFromPosX*(local_x: float32,
    center_x_ratio: float32 = 0.5f): void {.importc: "igSetScrollFromPosX".}
proc igSetScrollFromPosY*(local_y: float32,
    center_y_ratio: float32 = 0.5f): void {.importc: "igSetScrollFromPosY".}
proc igSetScrollHereX*(center_x_ratio: float32 = 0.5f): void {.
    importc: "igSetScrollHereX".}
proc igSetScrollHereY*(center_y_ratio: float32 = 0.5f): void {.
...
proc igSetWindowCollapsed*(collapsed: bool,
    cond: ImGuiCond = 0.ImGuiCond): void {.importc: "igSetWindowCollapsedBool".}
proc igSetWindowCollapsed*(name: cstring, collapsed: bool,
    cond: ImGuiCond = 0.ImGuiCond): void {.importc: "igSetWindowCollapsedStr".}
...
proc igSetWindowPos*(pos: ImVec2, cond: ImGuiCond = 0.ImGuiCond): void {.
    importc: "igSetWindowPosVec2".}
proc igSetWindowPos*(name: cstring, pos: ImVec2,
    cond: ImGuiCond = 0.ImGuiCond): void {.importc: "igSetWindowPosStr".}
proc igSetWindowSize*(size: ImVec2, cond: ImGuiCond = 0.ImGuiCond): void {.
    importc: "igSetWindowSizeVec2".}
proc igSetWindowSize*(name: cstring, size: ImVec2,
    cond: ImGuiCond = 0.ImGuiCond): void {.importc: "igSetWindowSizeStr".}
...
proc igShowStyleSelector*(label: cstring): bool {.
...
proc igSliderScalarN*(label: cstring, data_type: ImGuiDataType, p_data: pointer,
    ...
    power: float32 = 1.0f): bool {.importc: "igSliderScalarN".}
...
proc igTextColoredV*(col: ImVec4, fmt: cstring): void {.
    importc: "igTextColoredV", varargs.}
...
proc igTreeNode*(str_id: cstring, fmt: cstring): bool {.
    importc: "igTreeNodeStrStr", varargs.}
proc igTreeNode*(ptr_id: pointer, fmt: cstring): bool {.
    importc: "igTreeNodePtr", varargs.}
proc igTreeNodeEx*(label: cstring, flags: ImGuiTreeNodeFlags = 0.ImGuiTreeNodeFlags): bool {.
    importc: "igTreeNodeExStr".}
proc igTreeNodeEx*(str_id: cstring, flags: ImGuiTreeNodeFlags,
    fmt: cstring): bool {.importc: "igTreeNodeExStrStr", varargs.}
proc igTreeNodeEx*(ptr_id: pointer, flags: ImGuiTreeNodeFlags,
    fmt: cstring): bool {.importc: "igTreeNodeExPtr", varargs.}
proc igTreeNodeExV*(str_id: cstring, flags: ImGuiTreeNodeFlags,
    fmt: cstring): bool {.importc: "igTreeNodeExVStr", varargs.}
proc igTreeNodeExV*(ptr_id: pointer, flags: ImGuiTreeNodeFlags,
    fmt: cstring): bool {.importc: "igTreeNodeExVPtr", varargs.}
proc igTreeNodeV*(str_id: cstring, fmt: cstring): bool {.
    importc: "igTreeNodeVStr", varargs.}
proc igTreeNodeV*(ptr_id: pointer, fmt: cstring): bool {.
    importc: "igTreeNodeVPtr", varargs.}
...
proc igVSliderFloat*(label: cstring, size: ImVec2, v: ptr float32,
    ...
    power: float32 = 1.0f): bool {.importc: "igVSliderFloat".}
proc igVSliderInt*(label: cstring, size: ImVec2, v: ptr int32, v_min: int32,
    v_max: int32, format: cstring = "%d"): bool {.importc: "igVSliderInt".}
proc igVSliderScalar*(label: cstring, size: ImVec2, data_type: ImGuiDataType,
    ...
    power: float32 = 1.0f): bool {.importc: "igVSliderScalar".}
